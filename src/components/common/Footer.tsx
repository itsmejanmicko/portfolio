...
const Footer: React.FC = () => {
  return (
    <div className="w-full max-w-96 bg-gray-800 text-gray-100 fixed bottom-3 left-1/2 transform -translate-x-1/2 py-4 px-6 flex justify-center items-center space-x-10 rounded-3xl shadow-lg">
