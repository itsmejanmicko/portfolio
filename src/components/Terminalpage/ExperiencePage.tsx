import accessPoint from '../../../public/jmKGsL5s.jpg'
import switchs from '../../../public/OZBthtS5.jpg'
import cisco from '../../../public/QGJc_426.jpg'
  ...
  return (
    <div className="min-h-screen flex bg-gray-900 text-gray-100" id="experience">
      ...
      <div className="max-w-4xl mx-auto px-4 py-20 mb-10">
        ...
        <div className="sm:w-screen mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
